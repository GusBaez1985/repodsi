...
import ar.utn.ba.ddsi.agregador.services.IServicioRefrescoColecciones;
...
public class ServicioRefrescoColecciones implements IServicioRefrescoColecciones {
    ...
    public ServicioRefrescoColecciones(IHechoRepository fuenteDinamica,
																			 IHechoRepository fuenteEstatica) {
