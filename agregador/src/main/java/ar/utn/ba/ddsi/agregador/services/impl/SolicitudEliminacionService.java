...
import ar.utn.ba.ddsi.agregador.services.ISolicitudEliminacionService;
...
public class SolicitudEliminacionService implements ISolicitudEliminacionService {
	...
	public SolicitudEliminacion realizarSolicitudEliminacion(Hecho hecho, String motivo) {
		SolicitudEliminacion nuevaSolicitudEliminacion = new SolicitudEliminacion(motivo, hecho, hecho.getId());
